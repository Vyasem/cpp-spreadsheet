...
void UnitTest::TestInvalidPosition() {
    auto sheet = CreateSheet();
    try {
...
void UnitTest::TestSetCellPlainText() {
    auto sheet = CreateSheet();
...
void UnitTest::TestFormulaArithmetic() {
    auto sheet = CreateSheet();
...
void UnitTest::TestFormulaReferences() {
    auto sheet = CreateSheet();
    auto evaluate = [&](std::string expr) {
        return std::get<double>(ParseFormula(std::move(expr))->Evaluate(*sheet));
    };
...
void UnitTest::TestFormulaExpressionFormatting() {
...
void UnitTest::TestFormulaReferencedCells() {
...
void UnitTest::TestCellReferences() {
    auto sheet = CreateSheet();
    sheet->SetCell("A1"_pos, "1");
...
void UnitTest::TestFormulaIncorrect() {
...
void UnitTest::TestCellCircularReferences() {
    auto sheet = CreateSheet();
...
void UnitTest::TestValidFormula() {
    auto sheet = CreateSheet();
    sheet->SetCell("A1"_pos, "=1");
